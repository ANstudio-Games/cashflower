...
| **Backup & Restore** | Cadangkan seluruh database dalam format file `.json` ke Google Drive, WhatsApp, atau penyimpanan lokal untuk dipulihkan sewaktu-waktu. |
...
1. Buka menu **Pengaturan** (ikon roda gigi di pojok kanan atas beranda) -> **Atur Target Budgeting**.
...
1. Buka tab **Beranda** -> ketuk ikon **Pengaturan (Roda Gigi)** di kanan atas.
...
2. Buka **Pengaturan** -> ketuk **Pulihkan Data dari Cadangan**.
...
1. Masuk ke tab **Transaksi** atau **Grafik**, lalu ketuk tombol **Ekspor** di pojok kanan atas (atau buka **Pengaturan** -> **Ekspor Laporan Keuangan**).
...
1. Buka kartu **Target Pembelian & Rencana** di Beranda (atau buka **Pengaturan** -> **Target Pembelian & Rencana**).
...
1. **Mengatur Dompet:** Buka Beranda pada bagian **Dompet & Rekening** (atau buka **Pengaturan** -> **Kelola Dompet & Rekening**).
...
> * Buka *Pengaturan HP* -> *Aplikasi* -> *Cashflower* -> *Notifikasi* -> Pilih *Izinkan Notifikasi*.
...
<div align="center">
  <sub>Dibuat untuk kemudahan pengelolaan finansial yang rapi, transparan, dan bebas ribet.</sub>
</div>
